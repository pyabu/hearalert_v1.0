                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      .scale(begin: const Offset(1, 1),
                          end: const Offset(0.5, 0.5), duration: 800.ms),
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: List.generate(text.length, (i) {
        final isCapital = text[i] == text[i].toUpperCase() && text[i] != text[i].toLowerCase();
        return Text(
          text[i],
          style: GoogleFonts.spaceGrotesk(
            ...
            .animate()
            .fadeIn(delay: Duration(milliseconds: 500 + i * 65), duration: 400.ms)
...
class _SoundBarsLoader extends StatelessWidget {
  ...
  static final _heights = [16.0, 28.0, 42.0, 56.0, 42.0, 64.0, 42.0, 56.0, 42.0, 28.0, 42.0, 16.0];
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: List.generate(12, (i) {
        final h = _heights[i] * (0.3 + 0.7 * (math.sin(animValue * math.pi * 2 + _phases[i]) * 0.5 + 0.5));
        final t = i / 12;
...
class _ParticleFieldPainter extends CustomPainter {
  ...
  static final _particles = List.generate(_count, (i) => _Particle(
    x: _rng.nextDouble(),
    y: _rng.nextDouble(),
  ...
  void paint(Canvas canvas, Size canvasSize) {
    for (final p in _particles) {
      ...
      final opacity = (math.sin(progress * math.pi * 2 + p.phase * math.pi * 2) * 0.3 + 0.4).clamp(0.05, 0.7);
...
class _Particle {
  ...
  const _Particle({
    ...
    required this.size, required this.phase, required this.drift,
